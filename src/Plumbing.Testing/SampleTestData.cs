...
public class SampleTestData {
    ...
    private int limitStringLengthTo = 2000;
    ...
    public int LimitStringsTo {
        get { return limitStringLengthTo; }
        set { limitStringLengthTo = value; }
    }
    ...
    public string GenerateString() {
        return GenerateRandomString(1, limitStringLengthTo);
    }
    ...
    public string GenerateString(int minimumLength) {
        ...
        if (minimumLength > limitStringLengthTo) {
        ...
        return GenerateRandomString(minimumLength, limitStringLengthTo);
    }
