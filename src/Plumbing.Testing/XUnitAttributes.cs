namespace Plisky.Test {
    ...
    public class CategoryDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME = Traits.AssemblyName + "." + nameof(CategoryDiscoverer);
    ...
    public class IntegrationDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(IntegrationDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
    ...
    public class UnitDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(UnitDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
    ...
    public class FreshDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(FreshDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
    ...
    public class BuildDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(BuildDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
    ...
    public class BugDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(BugDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
    ...
    public class IsolatedDiscoverer : ITraitDiscoverer {
        internal const string DISCOVERER_TYPENAME =Traits.AssemblyName + "." + nameof(IsolatedDiscoverer);
        public IEnumerable<KeyValuePair<string, string>> GetTraits(IAttributeInfo traitAttribute) {
